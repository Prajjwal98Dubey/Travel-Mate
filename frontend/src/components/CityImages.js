...
const CityImages = ({selectedCity}) => {
  ...
  return (
    <>
    { selectedCity[0].images.length===0 ? <div className='flex justify-center items-center w-[500px] h-[300px] border border-gray-400'><div className='text-2xl font-bold'>"No Images to show!!!"</div></div> : <div className='flex relative'>
