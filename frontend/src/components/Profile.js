                ...
                <div className='text-white'>
                    <div className='w-full h-[400px] bg-red-500 relative'>
                        ...
                        <div className='flex justify-center'>
                            <div className=' relative p-2 cursor-pointer hover:bg-black rounded-full' onMouseEnter={() => setIsHoveredEdit(true)} onMouseLeave={() => setIsHoveredEdit(false)}><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-pencil"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" /><path d="m15 5 4 4" /></svg>
                    ...
                    {isLoadingBlog? <div>Loading Blogs...</div>:<div className='flex justify-center'>
                        <div>
                        {blogs.length===0 ? <div>You have not written any blog.</div>: blogs.map((blog)=><MyBlogs key={blog._id} blog={blog}/>)}
                        </div>
                    </div>}
                </div>
